...
readonly EXPECTED_RELEASE_TAG="20260809-admin-policy-review-r6.3"
readonly IMPLEMENTATION_COMMIT="43a42392cf975891ddb284083efe153581388d55"
readonly EXPECTED_ADMIN_IMAGE="lana-chatbot-app:admin-policy-review-r6.3"
readonly EXPECTED_MANIFEST_SHA256="0fae2b8439629fff47bd22b80a2aa3484b0ab8afc7bf659abbe3664a4c30a83e"
...
require_image_inputs() {
  ...
  test -f "$ROLLBACK_COMPOSE_OVERRIDE" || die "rollback Compose override missing"
}
