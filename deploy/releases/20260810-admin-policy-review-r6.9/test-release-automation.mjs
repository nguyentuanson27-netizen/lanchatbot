...
try {
  ...
  const release = '20260810-admin-policy-review-r6.9';
  ...
  requireText('common.sh', /EXPECTED_RELEASE_TAG="20260810-admin-policy-review-r6\.9"/, 'r6.9 identity is not pinned');
