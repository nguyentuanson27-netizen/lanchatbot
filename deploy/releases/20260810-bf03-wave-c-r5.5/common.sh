...
readonly EXPECTED_MANIFEST_SHA256="23a63d436ad7a219ddb5e6d0bc5251f2017345fef276cfe1b52ebfa9743f3baa"
...
readonly EXPECTED_PREVIOUS_RELEASE="20260810-admin-policy-review-r6.10"
readonly EXPECTED_PREVIOUS_COMPOSE_SHA256="e59ab08b6ad42c2d1d2e3a5a11ce9e34a935921c866917b0d23b6c3c5d69ac33"
readonly EXPECTED_ROLLBACK_REALTIME_IMAGE="lana-chatbot-app:bf01-reconcile-final-reply-r5.4"
...
readonly EXPECTED_CANDIDATE_TAG="20260810-bf03-wave-c-r5.5-review-candidate.1"
...
upsert_env_pin() {
  ...
  case "$key" in
    ...
    REALTIME_RELEASE_ID) validate_release_id "$value" ;;
