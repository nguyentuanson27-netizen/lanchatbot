# Admin Policy Review r6.4 deployment

This directory is the reviewed production automation for
`20260809-admin-policy-review-r6.4`. It supersedes the unexecuted r6.3
...
3. Run `run-build.sh`. It archives the immutable tag, builds the r6.4 image,
