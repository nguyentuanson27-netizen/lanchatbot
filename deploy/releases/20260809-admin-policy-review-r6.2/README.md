# Admin Policy Review r6.2 deployment

This directory is the reviewed production automation for
`20260809-admin-policy-review-r6.2`. It supersedes the unexecuted r6.1
...
3. Run `run-build.sh`. It archives the immutable tag, builds the r6.2 image,
