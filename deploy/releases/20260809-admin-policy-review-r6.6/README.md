# Admin Policy Review r6.6 deployment

This directory is the reviewed production automation for
`20260809-admin-policy-review-r6.6`. It supersedes the unexecuted r6.5
...
3. Run `run-build.sh`. It archives the immutable tag, builds the r6.6 image,
