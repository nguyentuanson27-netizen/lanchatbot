# Admin Policy Review r6.7 deployment

This directory is the reviewed production automation for
`20260809-admin-policy-review-r6.7`. It supersedes the unexecuted r6.6
...
3. Run `run-build.sh`. It archives the immutable tag, builds the r6.7 image,
