# Admin Policy Review r6.5 deployment

This directory is the reviewed production automation for
`20260809-admin-policy-review-r6.5`. It supersedes the unexecuted r6.4
...
3. Run `run-build.sh`. It archives the immutable tag, builds the r6.5 image,
