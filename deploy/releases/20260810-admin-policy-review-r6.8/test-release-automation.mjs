...
try {
  ...
  const release = '20260810-admin-policy-review-r6.8';
  ...
  requireText('common.sh', /EXPECTED_RELEASE_TAG="20260810-admin-policy-review-r6\.8"/, 'r6.8 identity is not pinned');
  ...
  requireText('migrate-production.sh', /packages\/database\/dist\/migrate\.js up/, 'production migration runner missing');
