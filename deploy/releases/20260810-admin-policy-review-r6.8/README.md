# Admin Policy Review r6.8 deployment

This directory is the production automation for
`20260810-admin-policy-review-r6.8`. It supersedes the deployed r6.7 release and
...
3. Run `run-build.sh`. It archives the immutable tag, builds the r6.8 image,
