...
#
# apps/worker/dist/p23c-recognition-server.js runs a single publish cycle and
...
COMPOSE_FILE="${COMPOSE_FILE:-/opt/lana-chatbot/current/deploy/docker-compose.vps.yml}"
