...
| r32.2 PR-B D1 Size preservation | CODE_COMPLETE | feat/r32.2-size-preservation / PR #102 | `3170307` | Worker 32 files; 332 pass; 4 target todo; targeted 58 pass, 4 todo; typecheck and full repository check pass | Not deployed; production remains r31.3 with outbound locked | Preserves verified price, stock, ETA, image, and CTA; emits a separate size handoff. Must not deploy before PR-D/PR-E close the ownership and ordering dependency. |
| r32.2 PR-C D2/D3 Vertex fallback and Voice/CTA compatibility | CODE_COMPLETE | fix/r32.2-vertex-voice-fallback / PR #103 | `1a03b49` | Worker 32 files; 334 pass; 3 target todo; targeted 68 pass, 3 todo; typecheck and full repository check pass | Not deployed; production remains r31.3 with outbound locked | Initial schema/provider errors and grounded-draft errors use one deterministic verified-facts fallback; model and fallback paths share Wave 2 Voice/CTA policy with at most one eligible question. |
| r32.2 PR-D D4 Atomic response-group delivery gate | CODE_COMPLETE | fix/r32.2-response-group-gate / PR #104 | `7f49508` | Worker 32 files; 339 pass; 2 target todo; targeted gate/shield 19 pass, 2 todo; database 106 pass; typecheck and full repository check pass | Not deployed; production remains r31.3 with outbound locked | One durable Pancake snapshot per response group; missing/error/unverified/stale/expired evidence fails closed before sequence 0; terminal decision is reused without per-sequence rereads. Must not deploy before PR-E closes descendant/watchdog ordering. |
