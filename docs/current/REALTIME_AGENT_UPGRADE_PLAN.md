...
| r32.1 incident containment + r31.3 rollback runbook | CODE_COMPLETE | docs/r32.2-incident-containment / PR pending | pending | AGENTS invariants; addendum JSON parse; docs links | — | Docs-only; outbound lock, rollback and requeue not executed |
