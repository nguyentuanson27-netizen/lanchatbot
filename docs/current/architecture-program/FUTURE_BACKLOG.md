...
**Current status:** **GATE_F_PREPROD_ACCEPTED / DF_C_COMPLETE.** The exact stopped-process release, migration 0035, rollback/reactivation lifecycle and controlled Messenger E2E are recorded in `DF13_GATE_F_PREPROD_ACCEPTANCE_20260828.md`. PREPROD remains on COMMERCE with `stateReadMode=LEGACY`; BF-03/BF-04/BF-10 and `DATABASE_URL` residuals remain unchanged. This status is not public-production promotion, page expansion, UR/State V2 approval or LEGACY deletion authority.
