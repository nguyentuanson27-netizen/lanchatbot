...
- [ ] Merge the focused BF-08 candidate-instruction remediation, then derive a new candidate/registration/anchor and bounded scored run. Never retry or relabel v18.
