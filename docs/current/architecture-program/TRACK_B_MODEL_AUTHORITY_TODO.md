...
- [ ] Merge the focused v17-preflight remediation, derive a new exact candidate/registration/anchor, and run one newly governed bounded scored invocation. Preserve every failed attempt and repeat only through the owner-authorized new-candidate loop.
