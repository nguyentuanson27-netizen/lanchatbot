...
- [ ] Merge the focused v21 product-switch instruction remediation, then derive and register one new exact candidate and execute exactly one newly authorized bounded scored run. Stop and preserve its evidence if it fails or source drifts.
