...
**Status:** `B2.4_MERGED / B3.1_V22_GATE_E_PASS / B3.2_ADMISSION_GATE_SOURCE_IN_PROGRESS / MIGRATIONS_0036_0037_PREPROD_APPLIED / MIGRATION_0038_PENDING_SOURCE_ONLY / NO_DEPLOY_OR_POINTER_MUTATION`
...
- [ ] Review and merge pending migration `0038_track_b_commerce_admission_gate` as source only. It depends on applied `0036/0037` and atomically holds `webhook_inbox -> PROCESSING`, `meta_outbox -> SENDING`, and `pancake_tag_outbox -> APPLYING` for the matching page while any matching `MESSENGER` fence is unreleased, including after lease expiry. New inbound remains durable/queued and existing leases can drain. Installation/removal serialize against fence acquisition, and down refuses unless there are zero unreleased fences. Current source hashes are up `7d1f3f8916e0a7ba63502d4fc7e2b794e20b65ac833a8c84776012cf80be56ca`, down `5dd292a169a5ecce5f21896bf8e11f1d7727a34a55758c92b8abc98f3de64d9a`. These hashes are not authorized for rehearsal or live apply by source merge.
