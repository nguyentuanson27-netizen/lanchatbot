...
**Status:** `B2.4_MERGED / B3.1_V22_REGISTRATION_PREPARED / MIGRATION_0036_PREPROD_APPLIED / NO_DEPLOY_OR_POINTER_MUTATION`
...
- [ ] Merge and anchor the immutable `evaluation/gate-e/track-b-v22` registration, then execute exactly one newly authorized bounded scored run. Stop and preserve its evidence if it fails or source drifts.
