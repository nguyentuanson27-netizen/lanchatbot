...
- Production hiện hành: `/opt/lana-chatbot/releases/20260724-realtime-measurement-continuation-r17`.
...
- Realtime Worker đang chạy image `lana-chatbot-app:realtime-measurement-continuation-r17`; Admin API/Admin Web/P2.3B giữ image r16 và P2.3C giữ image r15. Page allowlist vẫn chỉ có `1198992073286645`.
...
- Realtime page test chạy r17 với ProductFactsV2, Media Selector V2, profile/variant/multi-fact và hard gate chỉ cho page `1198992073286645`; Size Chart scheduler vẫn giữ pre-check idempotent.
...
Chi tiết bằng chứng runtime và ownership nằm tại [Production baseline](docs/current/PRODUCTION_BASELINE_20260722.md). Manifest mới nhất là [Realtime measurement continuation r17](deploy/manifests/20260724-realtime-measurement-continuation-r17.json). Rollback realtime dùng image r15 và release source gần nhất là r16.
