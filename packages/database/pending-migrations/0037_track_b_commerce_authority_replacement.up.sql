-- Pending Track B B3.2 schema artifact. Applying it requires separate owner
-- authorization and exact ENGINEERING_PREPROD rehearsal/readback. It extends
-- only the existing 0036 insert guard; it does not move a behavior pointer.
