CREATE TEMP TABLE migration_0032_admin_events_acl
ON COMMIT DROP AS
SELECT
  grantee,
  privilege_type,
...
CREATE TEMP TABLE migration_0032_admin_events_owner
ON COMMIT DROP AS
...
BEGIN
  FOR acl_row IN
    ...
    FROM migration_0032_admin_events_acl
  LOOP
    grantee_sql := CASE
  ...
  SELECT migration_0032_admin_events_owner.owner_name
  INTO owner_name
  FROM migration_0032_admin_events_owner;
