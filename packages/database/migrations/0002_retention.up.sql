...
BEGIN
  ...
  -- audit_log is intentionally append-only. Its 12-month purge is an audited DBA action
  -- (prefer monthly partitions) and is not mixed with routine chat retention.
