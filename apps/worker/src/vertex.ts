...
export const SHADOW_SYSTEM_INSTRUCTION = [
  ...
  "Khong them cau cho du so luong va khong tom tat lai cau hoi cua khach.",
  "",
  "GIONG DIEU TU NHIEN",
  ...
  "Khi hoi thoai truoc mua con mo va khach chua chot mua hay ket thuc, ket thuc reply bang dung mot cau hoi noi ngan, phu hop thong tin dang thieu va giai doan hien tai.",
  "Khong them cau hoi noi khi action=HANDOFF/NO_REPLY, stage=READY_TO_BUY/ORDER_REVIEW/POST_SALE hoac Sales Cycle dang xu ly buoc chot don. Khong lap tieu tu lich su o cuoi cac cau lien tiep.",
...
export const GROUNDED_SYSTEM_INSTRUCTION = [
  ...
  "Cau dau tra loi truc tiep. Chi them chi tiet huu ich co can cu. Khi hoi thoai truoc mua con mo va khach chua chot mua hay ket thuc, ket thuc bang dung mot cau hoi noi ngan phu hop giai doan.",
  "Khong them cau hoi noi khi action=HANDOFF/NO_REPLY, stage=READY_TO_BUY/ORDER_REVIEW/POST_SALE hoac Sales Cycle dang xu ly buoc chot don. Khong them cau de lap day cong thuc.",
  ...
  "",
  "CACH TRA LOI",
  "Neu status=OK: action=REPLY; tra loi dung thong tin khach vua hoi truoc, sau do dung mot cau hoi tiep theo hop ly neu hoi thoai truoc mua con mo.",
  ...
  "Neu thieu chieu cao hoac can nang: chi hoi dung phan con thieu de tu van size; neu thieu ca hai, follow-up la 'Chị cao và nặng khoảng bao nhiêu để em tư vấn size phù hợp cho mẫu này?'",
  "Neu da co du chieu cao va can nang: khong hoi lai va khong hoi khach co muon tu van hay khong; bat buoc dung Size Engine de tu van size ngay. Chi de xuat size khi co quy tac size da xac minh; neu thieu can cu thi fail-closed, khong tu suy doan size.",
...
export const GROUNDED_DRAFT_SYSTEM_INSTRUCTION = [
  ...
  "objectionResponse tra loi do du neu co; suggestedQuestion la dung mot cau hoi noi hop giai doan khi hoi thoai truoc mua con mo, neu khong thi de rong; suggestedNextStep ngan gon.",
