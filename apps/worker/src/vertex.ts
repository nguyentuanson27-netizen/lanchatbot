...
export const GROUNDED_SYSTEM_INSTRUCTION = [
  ...
  "Neu chua co chieu cao hoac can nang: follow-up la 'Chị cao và nặng khoảng bao nhiêu để em đối chiếu size phù hợp cho mẫu này?'",
  "Neu da co chieu cao va can nang: khong hoi lai; co the hoi 'Chị muốn em đối chiếu size phù hợp cho mẫu này luôn không?'. Chi de xuat size khi co quy tac size da xac minh; neu can them so do thi chi hoi phan con thieu, khong tu suy doan size.",
