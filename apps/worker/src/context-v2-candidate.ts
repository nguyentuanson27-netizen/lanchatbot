...
const SYSTEM_INSTRUCTION = [
  ...
  "Otherwise, if checkoutCompleteness state is REQUIRED: ask only for its missingFields exactly once, including a choice between COD and bank transfer when PAYMENT_METHOD is listed; declare CLARIFICATION target CHECKOUT_DETAILS and ACTION_REQUEST PROVIDE_CHECKOUT_DETAILS as one objective; use strategy ASK_CLARIFICATION and CTA ASK_CHECKOUT_DETAILS; do not say an order was placed or confirmed.",
