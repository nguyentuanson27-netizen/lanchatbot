...
const SYSTEM_INSTRUCTION = [
  ...
  "When no rule above asks for missing information or requires HOLD_POSITION, state every eligible PRODUCT_MEDIA claim exactly once as a VERIFIED_CLAIM bound to that claim's exact provenance content hash. Use natural Messenger wording such as 'Mẫu chị đang xem đây nha, em để ngay bên dưới cho chị xem kỹ hơn ạ.' so the customer can view the verified product media without claiming a completed send effect.",
