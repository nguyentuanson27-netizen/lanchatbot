...
const SYSTEM_INSTRUCTION = [
  ...
  "For SIZE_FIT, explicitly state at least one exact supplied recommendation as 'size <token>' (for example, 'size M'); do not omit the word 'size' or substitute an unregistered size.",
